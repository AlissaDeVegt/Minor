...
//for some reason if the include is done in header file errors show up.
...
namespace Card {
    ...
    void Window::drawFrame()
    {
        ...
        //if new model loaded update vertices and vertex;
...
#pragma region vulkan
    ...
    */
    ...
    {
        Model loadedmodel = ModelLoader::readModelFile(MODEL_PATH);
        //loadedmodel.moveObject(glm::vec3{ 0.0f,0.0f,-0.5f });
        vertices = loadedmodel.getVertices();
        indices = loadedmodel.getIndices();

        Model loadedmodel2 = ModelLoader::readModelFile(MODEL_PATH);
        loadedmodel2.moveObject(glm::vec3{ 0.0f,0.0f,-0.5f });
        std::vector<Vertex> vertex = loadedmodel2.getVertices();
        std::vector<uint32_t> index = loadedmodel2.getIndices();
        ...
        {
            indices.push_back(index[i] + vertex.size());
        }
